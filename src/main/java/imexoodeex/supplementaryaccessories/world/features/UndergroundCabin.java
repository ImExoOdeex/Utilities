package imexoodeex.supplementaryaccessories.world.features;
...
public class UndergroundCabin extends StructureFeature<StructurePoolFeatureConfig> {

    public UndergroundCabin() {
        // Create the pieces layout of the structure and give it to the game
        super(StructurePoolFeatureConfig.CODEC, UndergroundCabin::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!UndergroundCabin.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            SupplementaryAccessories.LOGGER.log(Level.DEBUG, "Rundown House at {}", blockpos);
        }
